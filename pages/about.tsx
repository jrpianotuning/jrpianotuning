      ...
      <section className={`${styles.section}`}>
        <div className={styles.story__container}>
          ...
          <p>
            ...
            musical gatherings to come - because their piano sounds and feels{" "}
            <i>just right</i>.
            <br />
            <br />I was raised in a large, loving homeschool family in
            Smithfield, UT, and then Snowflake-Taylor, AZ. Thanks to parental
            support, I developed passions for piano technology and the Arabic
            language. I studied both subjects at BYU Provo (2016-2021) and
            graduated with a double major in Middle Eastern Studies/Arabic and
            Arabic Language in December 2021. Following a year of servicing
